            ...
            <div class="school-collections-container">
                <?php if($collections){ ?>
                    <div class="alert alert-info">
                        <strong><i class="fa fa-book"></i> Latest Collections!</strong> Find out what are the newly added collection of books from the last 7 days.
                    </div>
                <?php }; ?>
                <div class="collection-filters">
                    <form action="<?=base_url();?>/new-aquisition" method="GET">
