				...
				<div class="content">
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="card-box">
                                    <form action="<?=base_url();?>admin/add_this_student" data-parsley-validate novalidate method="POST" enctype="multipart/form-data" id="saveProfileForm">
                            ...
                            <div class="col-lg-4">
                        		<div class="card-box p-0">
                        			<div class="profile-widget text-center">
			                            ...
			                            <p class="text-muted"><i class="fa fa-map-marker"></i> <?=$profile['address']?></p>
			                            <p class="m-t-10 text-muted p-20">Department: <?=$profile['department']?></p>
                                        <?php $count_request = $this->student_model->count_all_request($this->session->userdata('id')); ?>
