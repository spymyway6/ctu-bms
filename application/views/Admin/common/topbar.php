<?php 
    ...
    $user_img = $this->admin_model->get_my_profile($my_user_id)['pic'];
   ...
   <div class="topbar-left">
        <div class="text-center">
            <a href="javascript:;" class="logo">
                <div class="plain-logo"><img src="<?=base_url();?>assets/front-office/img/core-img/logo.png" alt="Site Logo" /></div><span>CTU - ADMIN</span>
            </a>
        </div>
    </div>
