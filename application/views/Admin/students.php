                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    <?php if($this->session->userdata('role')==1 || strstr($this->session->userdata('permission'),'create_member')){ ?>
                                        <a href="javascript:;" class="btn btn-success waves-effect waves-light btn-sm pull-right" onclick="addNewCollection()"><i class="fa fa-plus"></i> Add New Students</a>
                                    <?php } ?>
                                    <h4 class="m-t-0 header-title"><b>Students of Books</b></h4>
